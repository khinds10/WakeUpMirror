...
subprocess.Popen( "sshpass -p '" + settings.sftpPass + "' scp -o 'StrictHostKeyChecking no' webcam.jpg " + settings.sftpUser + "@" + settings.sftpHost + ":" + settings.sftpFolder, shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
